<div class="slideshow">
  <div id="image1" class="fade">
    <img src="/assets/img/background.jpg" class="background2--container" width="100%" alt="background">
  </div>
  <div id="image2" class="fade">
    <img src="/assets/img/rD1eOT.jpeg" class="background2--container" width="100%" alt="background">
  </div>
  <div id="image3" class="fade">
    <img src="/assets/img/turtle-beach-stealth-pro-preorder-blogroll-1679582803054_vcah.jpeg" class="background2--container" width="100%" alt="background">
  </div>
</div>
