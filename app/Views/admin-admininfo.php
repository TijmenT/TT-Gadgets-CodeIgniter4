...
<div class="user-details">
    <form action="/edit-admin-data" method="post">
    <div class="field">
        <label for="adminID">Admin ID:</label>
        <input  type="text" id="adminID" name="admin_ID" value="<?php echo $user['admin_ID'] ?>" readonly>
    </div>
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="changeable" type="text" id="username" name="username" value="<?php echo $user['username'] ?>" readonly>
    </div>
    <div class="field">
        <label for="level">Level:</label>
        <input class="changeable" type="text" id="level" name="level" value="<?php echo $user['level'] ?>" readonly>
    </div>
